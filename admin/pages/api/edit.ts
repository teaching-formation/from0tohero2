...
const ALLOWED: Record<string, string[]> = {
  praticiens:      ['name','role','country','city','category','categories','bio','stack','badges','certifications','linkedin_url','github_url','youtube_url','website_url','twitter_url','whatsapp_url','status'],
